   ...
   render() {
     ...
     return (
       <View style={styles.container} {...this.props}>
         ...
         <TouchableOpacity
           style={[this.createToggleSwitchStyle(),{borderColor:'#FFFFFF',borderWidth:1}]}
           activeOpacity={0.8}
           onPress={() => (disabled ? null : onToggle(!isOn))}
         >
           {this.props.isOn?  <View style={{flexDirection:'row',justifyContent:'space-between',width:50,marginLeft:26}}>
             <Icon name="e2"/>
             <Icon name="e2"/>
             </View>:  <View style={{flexDirection:'row',justifyContent:'space-between',width:50,marginLeft:56}}>
             <Icon name="e1"/>
             <Icon name="e1"/>
             </View>}
           <Animated.View style={[this.createInsideCircleStyle(),{backgroundColor:this.props.isOn?"#1C60CD":"white"}]}>
